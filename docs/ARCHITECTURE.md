Real-Time Collaboration System - Todo Whiteboard                                                                                                                                           
                                                                                                                                                                                                
     Overview                                                                                                                                                                                   
                                                                                                                                                                                                
     Add real-time collaboration features to the Todo Whiteboard application including live cursor tracking, instant note updates, user presence, notifications with mute/unmute, and           
     ...
     │                         Frontend                                 │                                                                                                                       
     │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────────┐    │                                                                                                                         
     │  │  Auth    │  │ WebSocket│  │ Presence │  │ Notification │    │                                                                                                                         
     ...
     │  │  - Whiteboard viewer tracking         │                     │                                                                                                                         
     │  │  - In-memory pub/sub                  │                     │                                                                                                                         
     │  └───────────────────────────────────────┘                     │                                                                                                                         
     │                      │                                          │                                                                                                                        
     │  ┌──────────┐  ┌─────┴────┐  ┌──────────┐                      │                                                                                                                         
     │  │   REST   │  │ Broadcast│  │PostgreSQL│                      │                                                                                                                         
     │  │   APIs   │──│  Events  │──│    DB    │                      │                                                                                                                         
     │  └──────────┘  └──────────┘  └──────────┘                      │                                                                                                                         
     └─────────────────────────────────────────────────────────────────┘                                                                                                                        
